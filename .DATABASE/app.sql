...
CREATE DATABASE IF NOT EXISTS `app` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `app`;
...
INSERT INTO `administrator` (`administrator_id`, `username`, `password_hash`) VALUES
	(1, 'Aleksandar', '18F94E0E8472D0558A8B2C8BC832C7D22B378B50DF8DA2F0AC1F34FB4AF4EC85392B2B41A956153D86E87F7547C1B19BC9808C3F9878202F063399975852165D'),
	(2, 'Aleksandar1', 'KDWI213981294824KJDW9wd898wdWd'),
	...
	(4, 'mmilic', 'E2B97284666309313BC113D5288DC84DBDCD11016E92153087DCD6D2BC3479871A24A564942387E931BE5CC79836843D90F327474B5DA4AA5B1DE0A23200FA8F'),
...
CREATE TABLE IF NOT EXISTS `article` (
  ...
  `status` enum('dostupno','nije dostupno') NOT NULL DEFAULT 'dostupno',
...
INSERT INTO `article` (`article_id`, `name`, `category_id`, `excerpt`, `description`, `status`) VALUES
	(20, 'Ljuti', 1, '', 'ljuti', 'dostupno'),
	(21, 'ljuti ajvar', 1, '0', 'Neki duzi tekst', 'dostupno');
...
INSERT INTO `category` (`category_id`, `name`, `image_path`) VALUES
	(1, 'Ajvar', 'assets/ajvar.jpg'),
	(2, 'Dzem', 'assets/dzem.jpg'),
	(3, 'Slatko', 'assets/slatko.jpg'),
	(4, 'Tursija', 'assets/tursija.jpg'),
	(5, 'Kupus', 'assets/kupus.jpg');
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  `cart_id` int unsigned NOT NULL DEFAULT '0',
  `status` enum('prihvacena','odbijena','na cekanju') NOT NULL DEFAULT 'na cekanju',
...
INSERT INTO `user` (`user_id`, `email`, `password_hash`, `forename`, `surname`, `phone_number`, `postal_address`) VALUES
	(1, 'test@test.com', 'DDAF35A193617ABACC417349AE20413112E6FA4E89A97EA20A9EEEE64B55D39A2192992A274FC1A836BA3C23A3FEEBBD454D4423643CE80E2A9AC94FA54CA49F', 'Pera', 'Peric', '+3811234567', 'Nepoznata adresa');
